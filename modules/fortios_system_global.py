...
options:
    ...
    system_global:
        ...
        suboptions:
            ...
            ldapconntimeout:
                description:
                    - Global timeout for connections with remote LDAP servers in milliseconds (0 _ 4294967295, default 500).
            lldp_transmission:
                description:
            ...
            proxy_auth_timeout:
                description:
                    - Authentication timeout in minutes for authenticated users (1 _ 3600 sec, default = 300).
  ...
  - name: Configure global attributes.
    fortios_system_global:
      ...
      system_global:
        ...
        sys_perf_log_interval: "145"
        tcp_halfclose_timer: "146"
        tcp_halfopen_timer: "147"
        tcp_option: "enable"
        tcp_timewait_timer: "149"
        tftp: "enable"
        timezone: "01"
        tp_mc_skip_policy: "enable"
        traffic_priority: "tos"
        traffic_priority_level: "low"
        two_factor_email_expiry: "155"
        two_factor_fac_expiry: "156"
        two_factor_ftk_expiry: "157"
        two_factor_ftm_expiry: "158"
        two_factor_sms_expiry: "159"
        udp_idle_timer: "160"
        user_server_cert: "<your_own_value> (source certificate.local.name)"
        vdom_admin: "enable"
        vip_arp_range: "unlimited"
        virtual_server_count: "164"
        virtual_server_hardware_acceleration: "disable"
        wad_affinity: "<your_own_value>"
        wad_csvc_cs_count: "167"
        wad_csvc_db_count: "168"
        wad_source_affinity: "disable"
        wad_worker_count: "170"
...
def filter_system_global_data(json):
    option_list = ['admin_concurrent', 'admin_console_timeout', 'admin_https_pki_required',
                   ...
                   'tftp', 'timezone', 'tp_mc_skip_policy',
                   'traffic_priority', 'traffic_priority_level', 'two_factor_email_expiry',
                   'two_factor_fac_expiry', 'two_factor_ftk_expiry', 'two_factor_ftm_expiry',
                   'two_factor_sms_expiry', 'udp_idle_timer', 'user_server_cert',
                   'vdom_admin', 'vip_arp_range', 'virtual_server_count',
                   'virtual_server_hardware_acceleration', 'wad_affinity', 'wad_csvc_cs_count',
                   'wad_csvc_db_count', 'wad_source_affinity', 'wad_worker_count',
                   'wifi_ca_certificate', 'wifi_certificate', 'wimax_4g_usb',
                   'wireless_controller', 'wireless_controller_port']
    dictionary = {}
...
def flatten_multilists_attributes(data):
    multilist_attrs = [['admin_https_ssl_versions']]
...
def fortios_system(data, fos, check_mode=False):
    ...
    if check_mode or (not check_mode and data['system_global']):
